...
sudo apt-get update
declare -a PACKAGES=( 'cmake' 'vim' 'libgstreamer1.0-dev' 'libgstrtspserver-1.0-dev' 'gstreamer1.0-libav' 'gstreamer1.0-libav' 'gstreamer1.0-plugins-bad' 'gstreamer1.0-plugins-ugly' 'libx264-dev' )
